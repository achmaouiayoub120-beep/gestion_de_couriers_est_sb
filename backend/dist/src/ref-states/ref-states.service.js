...
exports.RefStatesService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let RefStatesService = class RefStatesService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        ...
        if (!state)
            throw new common_1.NotFoundException('État non trouvé');
        return state;
    }
    async create(dto) {
        const exists = await this.prisma.refState.findUnique({ where: { label: dto.label } });
        if (exists)
            throw new common_1.ConflictException('État déjà existant');
...
exports.RefStatesService = RefStatesService;
exports.RefStatesService = RefStatesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], RefStatesService);
//# sourceMappingURL=ref-states.service.js.map